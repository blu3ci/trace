  ...
  return <div>
    ...
    <div className="mt-5 grid gap-5 lg:grid-cols-[0.75fr_1.25fr]">
      ...
      <div className="space-y-5">
        ...
        <Card className="border-[#dbe3dc] bg-[#f7faf7]"><CardHeader className="pb-3"><CardTitle className="flex items-center gap-2 text-base"><BrainCircuit className="size-4 text-[#315943]" /> Writing-process summary</CardTitle><CardDescription>Instructor-only context from the saved milestones.</CardDescription></CardHeader><CardContent><p className="text-sm leading-6 text-[#405049]">Three saved milestones and 55 minutes of active writing document the submitted draft&apos;s progression. The receipt notes what was saved, without judging authorship or writing quality.</p><div className="mt-4 rounded-lg border border-[#dbe7de] bg-white/75 p-3"><div className="flex items-center justify-between gap-3"><p className="text-sm font-medium text-[#2e4134]">Saved milestone progression</p><p className="text-xs text-[#607067]">3 milestones</p></div><div className="mt-3 flex items-center"><span className="size-3 rounded-full bg-[#315943] ring-4 ring-white" /><span className="h-px flex-1 bg-[#c9dccd]" /><span className="size-3 rounded-full bg-[#a9c8ae] ring-4 ring-white" /><span className="h-px flex-1 bg-[#c9dccd]" /><span className="size-3 rounded-full bg-[#78a782] ring-4 ring-white" /></div><div className="mt-3 flex justify-between text-xs font-medium text-[#65716a]"><span>First saved draft</span><span>Latest saved draft</span></div></div></CardContent></Card>
      </div>
    </div>
  </div>;
}
