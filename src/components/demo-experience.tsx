  ...
  return <div>
    ...
    <div className="mt-5 grid gap-5 lg:grid-cols-[0.75fr_1.25fr]">
      ...
      <div className="space-y-5">
        ...
        <Card className="border-[#dbe3dc] bg-[#f7faf7]"><CardHeader className="pb-3"><CardTitle className="flex items-center gap-2 text-base"><BrainCircuit className="size-4 text-[#315943]" /> AI writing-process assessment</CardTitle><CardDescription>Instructor-only analysis of the saved writing record.</CardDescription></CardHeader><CardContent><p className="text-sm leading-6 text-[#405049]">Three saved milestones and 55 minutes of active writing provide the evidence for an instructor&apos;s review of the submitted draft.</p><div className="mt-4 grid gap-3 sm:grid-cols-3"><div className="rounded-lg border border-[#dbe7de] bg-white/75 p-3"><p className="text-xs text-[#65716a]">Process score</p><p className="mt-1 text-xl font-semibold text-[#2e4134]">91<span className="text-sm font-medium text-[#65716a]">/100</span></p></div><div className="rounded-lg border border-[#dbe7de] bg-white/75 p-3"><p className="text-xs text-[#65716a]">Evidence</p><p className="mt-1 text-sm font-medium text-[#2e4134]">Strong</p></div><div className="rounded-lg border border-[#dbe7de] bg-white/75 p-3"><p className="text-xs text-[#65716a]">Certainty</p><p className="mt-1 text-sm font-medium text-[#2e4134]">High</p></div></div><div className="mt-4 rounded-lg border border-[#dbe7de] bg-white/75 p-3"><div className="flex items-center justify-between gap-3"><p className="text-sm font-medium text-[#2e4134]">Saved milestone progression</p><p className="text-xs text-[#607067]">3 milestones</p></div><div className="mt-3 flex items-center"><span className="size-3 rounded-full bg-[#315943] ring-4 ring-white" /><span className="h-px flex-1 bg-[#c9dccd]" /><span className="size-3 rounded-full bg-[#a9c8ae] ring-4 ring-white" /><span className="h-px flex-1 bg-[#c9dccd]" /><span className="size-3 rounded-full bg-[#78a782] ring-4 ring-white" /></div><div className="mt-3 flex justify-between text-xs font-medium text-[#65716a]"><span>First saved draft</span><span>Latest saved draft</span></div></div></CardContent></Card>
      </div>
    </div>
  </div>;
}
