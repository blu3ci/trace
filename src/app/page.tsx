...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfaf7] text-[#1d2521] selection:bg-[#cddfd4]">
      ...
      <section
        id="how-it-works"
        className="border-y border-[#e5e5df] bg-[#f5f4ef]"
      >
      ...
      <section
        id="for-educators"
        className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-20 lg:px-10 lg:py-28"
      >
        <div>
...
function FeatureCard({
  ...
  return (
    <Card className="border-0 bg-[#fbfaf7] shadow-sm shadow-[#1d2521]/5">
      <CardHeader>
        <div className="flex items-center justify-between">
      ...
      <CardHeader className="border-b border-[#e8e9e4] px-5 py-4 sm:px-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="size-2 rounded-full bg-[#83b28c]" />
      ...
      <CardContent className="px-5 py-5 sm:px-6 sm:py-6">
        ...
        <div className="mt-6 space-y-1">
          {phases.map((phase, index) => (
            <div key={phase.title} className="grid grid-cols-[22px_1fr] gap-3">
